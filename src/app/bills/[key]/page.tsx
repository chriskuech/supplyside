...
import { withDetailPage } from '@/lib/resource/withDetailPage'

export default withDetailPage(
  'Bill',
  async function BillsDetail({ resource, schema, session: { user } }) {
    const status =
      selectValue(resource, fields.billStatus)?.option ??
