...
const _fields = {
  ...
  jobFiles: {
    ...
    type: 'Files',
    description:
      'The files that originally comprised the job, such as from the original customer email. You can sync Job information from these files.',
  },
  jobStatus: {
    templateId: '70912291-2b48-4e1f-9300-b7dbca8ce5ab',
    name: 'Job Status',
...
type FieldsDef = typeof _fields

export const fields: {
  [key in keyof FieldsDef]: FieldTemplate & FieldsDef[key]
} = _fields
